...
function buildQuestionLines({ topic, moduleId, schoolLabel, variant }) {
  ...
  if (moduleId === "college" || topic.includes("选课") || topic.includes("专业")) {
    return [
      `请问有 ${topic} 相关的同学吗，大家一般在哪里上课呀？`,
      `我也想问这个，我现在看房源看懵了，不知道住哪里方便一点`,
      `听说有些楼离市中心有点远，走路会不会每天都很崩？`,
      `那 New Era / Vita / Crown House 这种会不会好一点？我看到有人说有班车`,
      `班车要问清楚时间，有的可能下午就没了，不能只看“有班车”三个字`,
      `我想找同专业搭子，之后上课可以互相提醒一下`,
      `同专业可以冒个泡吗，想一起对一下上课楼和住宿距离`,
      `我现在主要想知道住哪片比较不折腾`,
    ];
  }
  ...
  return [
    `有人最近在看${topic}吗，我这边还没太弄明白`,
    `我也想问这个，感觉每个人看到的页面都不太一样`,
    `我主要怕自己漏掉${schoolLabel}的时间点`,
    `有已经弄完的吗，能不能说下大概顺序`,
    `不用发隐私，就说下入口或者页面名字就行`,
    `我邮箱里东西太多了，真的怕看漏`,
    `同问，我现在也只是在反复刷页面`,
